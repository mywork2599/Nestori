...
(function(){
  try {
    ...
    console.log('[property-modal] modal:', modal);
    const closeBtn = modal && modal.querySelector('.close-btn-property');
    console.log('[property-modal] closeBtn:', closeBtn);
    ...
    function closeModal(){
      console.log('[property-modal] closeModal called');
    ...
    console.log('[property-modal] event listeners set up');

    if(closeBtn) {
      closeBtn.addEventListener('click', closeModal);
      console.log('[property-modal] event listener added for closeBtn');
    }
